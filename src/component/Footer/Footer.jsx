    ...
    <footer className="footer">
      <section>
        <div className="container-fluid">
          <div className="row">
            <div className="col-12 col-lg-4 bg2 py-4 py-md-5 py-xxl-8">
                  ...
                  <div className="social-media-wrapper mt-5">
                    <ul className="nav">
                      <li className="nav-item me-3">
                        <a className="nav-link link-primary p-2 bg-light rounded" href="https://www.facebook.com/arpan.rakshit.18">
                      ...
                      <li className="nav-item me-3">
                        <a className="nav-link link-primary p-2 bg-light rounded" href="https://www.youtube.com/@-nijedergaan3631">
                      ...
                      <li className="nav-item me-3">
                        <a className="nav-link link-primary p-2 bg-light rounded" href="https://x.com/ArpanRakshit6">
                      ...
                      <li className="nav-item">
                        <a className="nav-link link-primary p-2 bg-light rounded" href="https://www.instagram.com/street_man_2001/">
            ...
            <div className="col-12 col-lg-8 bg1 py-4 py-md-5 py-xxl-8">
                ...
                <div className="col-12 col-md-11 col-xxl-10">
                  ...
                  <div className="row mt-6 border-top border-light-subtle">
                    ...
                    <div className="credits text-secondary mt-2 fs-7">
                      Built by <a href="https://github.com/apurakshit2001" className="link-secondary text-decoration-none">apurakshit2001</a> with <span className="text-primary">&#9829;</span>
                    </div>
                  </div>
                </div>
              </div>
